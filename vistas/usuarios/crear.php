    ...
    <div class="card-body">
        ...
        <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input Required type="email" class="form-control" name="correo" id="correo" aria-describedby="helpId" placeholder="correo"/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input Required type="password" class="form-control" name="clave" id="clave" aria-describedby="helpId" placeholder="Clave"/>
            </div>
            <div class="form-group">
