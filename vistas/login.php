...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <div class="container">
                    <div class="row">
                    <div class="col"></div> <!-- columna izquierda no usada--> 
                        ...
                        <div class="col"><!-- columna central--> 
                                ...
                                <div class="card text-center">
                                    ...
                                    <form action="index.php?controlador=login&accion=login" method="post">
                                            <div class="mb-3">
                        ...
                        <div class="col"></div><!-- columna derecha no usada--> 
                    </div>
            </div>
        ...
        <script>
            $(document).ready(function(){
                $('#usuario').keypress(function(evento){
                    if(evento.which == 13){
